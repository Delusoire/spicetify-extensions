...
(keyboard ||= {}).shortcuts = (() => {
  ...
  var import_function13, SCROLL_STEP, focusOnApp, appScroll, appScrollY, openPage, rotateSidebar, resizeLeftSidebar, registerBind;
  var init_util = __esm({
    "extensions/keyboard-shortcuts/util.tsx"() {
      "use strict";
      ...
      rotateSidebar = (offset) => {
        ...
        (0, import_function13.pipe)(
          ...
          (x) => (0, import_function13.pipe)(x === -1 && offset <= 0 ? offset : x + offset, mod(navLinks.length)),
          (x) => navLinks[x].click()
        );
      };
