...
((play ||= {}).enhanced ||= {}).songs = (() => {
  ...
  var URI4, map4, Functor3, of5, ap4, Applicative3, apFirst4, apSecond4, chain3, Monad3, Do3, bindTo4, bind4, apS4, let_4, unary, unless, when, invoke, invokeNullary, memoize, curry2T, curry2, curry3T, curry3, curry4T, curry4, curry5T, curry5, applyEvery;
  var init_Function = __esm({
    ".yarn/__virtual__/fp-ts-std-virtual-08a4b07b6e/0/cache/fp-ts-std-npm-0.17.1-8c0fa4fe44-c9e2cba727.zip/node_modules/fp-ts-std/dist/esm/Function.js"() {
      init_Option();
      init_Map();
  ...
  var init_app = __esm({
    "extensions/play-enhanced-songs/app.tsx"() {
      ...
      new Spicetify.ContextMenu.Item(
        ...
        tupled(anyPass([URI6.isPlaylistV1OrV2])),
        "enhance"
      ).register();
    }
  });
