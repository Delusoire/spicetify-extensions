...
new PermanentMutationObserver("main", () => {
    ...
    trackLists
        ...
        .forEach(trackList => {
            ...
            new MutationObserver((record, observer) => _onTrackListMutation(trackList, record, observer)).observe(
...
`
__decorateClass([property({ type: Array })], AnimatedContentContainer.prototype, "content", 2)
__decorateClass([property({ type: Number })], AnimatedContentContainer.prototype, "tsrAbsolute", 2)
__decorateClass([property({ type: Number })], AnimatedContentContainer.prototype, "tsr", 2)
__decorateClass([property({ type: Number })], AnimatedContentContainer.prototype, "ter", 2)
// @ts-expect-error only has a getter
__decorateClass([queryAll("*:not(br)")], AnimatedContentContainer.prototype, "childs", 2)
AnimatedContentContainer = __decorateClass([customElement(AnimatedContentContainer.NAME)], AnimatedContentContainer)
...
__decorateClass([property()], SyncedScrolledContent.prototype, "content", 2)
__decorateClass([property({ type: Number })], SyncedScrolledContent.prototype, "tsrAbsolute", 2)
__decorateClass([property({ type: Number })], SyncedScrolledContent.prototype, "tsr", 2)
__decorateClass([property({ type: Number })], SyncedScrolledContent.prototype, "ter", 2)
__decorateClass([consume({ context: globalRSPSpringCtx })], SyncedScrolledContent.prototype, "globalRSPSpring", 2)
__decorateClass(
    [consume({ context: scrollTimeoutCtx, subscribe: true })],
    SyncedScrolledContent.prototype,
    "scrollTimeout",
    2,
)
__decorateClass([consume({ context: spotifyContainerCtx })], SyncedScrolledContent.prototype, "spotifyContainer", 2)
...
`
__decorateClass([property()], AnimatedFiller.prototype, "duration", 2)
AnimatedFiller = __decorateClass([customElement(AnimatedFiller.NAME)], AnimatedFiller)
...
`
__decorateClass([consume({ context: loadedLyricsTypeCtx })], AnimatedContent.prototype, "loadedLyricsType", 2)
AnimatedContent = __decorateClass([customElement(AnimatedContent.NAME)], AnimatedContent)
var LyricsContainer = class extends LitElement {
    ...
    updateProgress(progress) {
        if (this.loadedLyricsType === 0 /* NONE */ || this.loadedLyricsType === 1 /* NOT_SYNCED */) return
...
`
__decorateClass([property({ attribute: false })], LyricsContainer.prototype, "song", 2)
__decorateClass([provide({ context: loadedLyricsTypeCtx }), state()], LyricsContainer.prototype, "loadedLyricsType", 2)
// @ts-expect-error only has a getter
__decorateClass([query(AnimatedContentContainer.NAME)], LyricsContainer.prototype, "firstContainer", 2)
__decorateClass([provide({ context: globalRSPSpringCtx })], LyricsContainer.prototype, "globalRSPSpring", 2)
__decorateClass([provide({ context: scrollTimeoutCtx })], LyricsContainer.prototype, "scrollTimeout", 2)
__decorateClass([provide({ context: spotifyContainerCtx })], LyricsContainer.prototype, "spotifyContainer", 2)
LyricsContainer = __decorateClass([customElement(LyricsContainer.NAME)], LyricsContainer)
