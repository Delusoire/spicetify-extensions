...
var Eq4, Semigroup2, empty7, Monoid, Ord4, Show, isString, toUpperCase, toLowerCase, replace, trim, trimLeft, trimRight, slice, isEmpty3, size3, split, includes, startsWith, endsWith;
...
var init_String = __esm(() => {
  ...
  takeLeft3 = (n) => slice(0, max(Ord2)(0, n));
  takeRight3 = (n) => (x) => slice(max(Ord2)(0, x.length - Math.floor(n)), Infinity)(x);
...
var init_popup = __esm(() => {
  ...
  ButtonElement = ({ name = "", color = "", onClick = exports_Task.of(undefined) }) => import_react.default.createElement("button", {
...
class SettingsSection {
  ...
  SettingDropdownField = (field) => {
    ...
    }, field.options.map((option2, i) => import_react2.default.createElement("option", {
...
var import_react2, import_react_dom, FieldType;
...
var init_settings2 = __esm(() => {
  init_es6();
  init_settings();
  settings2 = new SettingsSection("Show The Genres", "show-the-genres").addInput("LFMApiKey", "Last.fm API Key", exports_Task.of("44654ea047786d90338c17331a5f5d95"));
