...
(star ||= {}).ratings = (() => {
  ...
  // shared/api.tsx
  var mustLoadForApi, fetchGQLAlbum, fetchWebArtistsSpot, fetchWebTracksSpot, fetchPlatArtistLikedTracks, fetchPlatPlaylistContents, createPlatFolder, createPlatPlaylist, setPlatPlaylistVisibility, fetchPlatFolder, addPlatPlaylistTracks, removePlatPlaylistTracks;
  var init_api = __esm({
    "shared/api.tsx"() {
      "use strict";
      init_fp();
  ...
  // shared/settings.tsx
  var import_function21, import_react, import_react_dom, mustLoadForSettings, SettingsSection;
  ...
  var require_Either = __commonJS({
    ".yarn/cache/fp-ts-npm-2.16.1-8deb3ec2d6-94e8bb1d03.zip/node_modules/fp-ts/lib/Either.js"(exports) {
      ...
      var getFilterable = function(M) {
        ...
        var partition8 = function(ma, p5) {
          return (0, exports.isLeft)(ma) ? (0, Separated_1.separated)(ma, ma) : p5(ma.right) ? (0, Separated_1.separated)(empty7, (0, exports.right)(ma.right)) : (0, Separated_1.separated)((0, exports.right)(ma.right), empty7);
        };
        return {
          URI: exports.URI,
          _E: void 0,
  ...
  var import_function22, starsS2N, starsN2S, getNowPlayingHeart, getStarsFromStarsContainer, getStarStopsFromStar, getStarsContainer, getStars, getStarsStops, getTrackLists, getTrackListHeader, getTrackListTracks, getLastColIndex, getFirstHeart, getTrackListTrackUri, getRatingsFolder;
  var init_util2 = __esm({
    "extensions/star-ratings/util.tsx"() {
      ...
      getStarsStops = (0, import_function22.flow)(getStars, Array_exports.map(getStarStopsFromStar));
  ...
  var import_function23, createStar, createStars, setStarsGradientByRating, calculateRatingFromMouseEvent, onStarClick;
  var init_stars = __esm({
    "extensions/star-ratings/stars.tsx"() {
      ...
      createStars = (idSuffix, size5) => {
        ...
        (0, import_function23.pipe)(starsConstructs, Array_exports.unzip, ([star]) => star, Array_exports.map(starsContainer.append));
      ...
      onStarClick = (nth, starElement, getTrackUri, getHeart) => async (e) => {
        ...
        const starsSVGStops = (0, import_function23.pipe)(starsContainer, getStarsFromStarsContainer, Array_exports.map(getStarStopsFromStar));
  ...
  var import_function24, w, aggregateRatings, addRatingsListenersToStars;
  ...
  __export(app_exports, {
    HALF_STAR_LENGTH: () => HALF_STAR_LENGTH,
    RATINGS_FOLDER_NAME: () => RATINGS_FOLDER_NAME,
    STAR_SIZE: () => STAR_SIZE,
  ...
  var import_NonEmptyArray, import_function25, import_spectacles_ts, app_default, URI9, RATINGS_FOLDER_NAME, STAR_SIZE, HALF_STAR_LENGTH, playlistUris, customTrackListColCss, loadRatings, tracksRatings, updateTrackList, mainElement, mainElementObserver, updateCollectionStars, createNowPlayingStars, nowPlayingHeart, updateNowPlayingStars;
  var init_app = __esm({
    "extensions/star-ratings/app.tsx"() {
      "use strict";
      init_es6();
      ...
      loadRatings = async () => {
        ...
        const starsS2Narray = (0, import_function25.pipe)(
          (0, import_NonEmptyArray.range)(0, 10),
          Array_exports.map((s) => [starsN2S(s), s]),
          Record_exports.fromEntries
        );
        const playlistUris2 = (0, import_function25.pipe)(
          ratingsFolder.items,
          Array_exports.map((p5) => [p5.type, p5.uri, starsS2Narray[p5.name]]),
          Array_exports.reduce(
            [],
            (acc, [type, uri, starsN]) => (type === "playlis" && starsN ? acc[starsN] = uri : [], acc)
          )
        );
        tracksRatings = await (0, import_function25.pipe)(
          playlistUris2,
      ...
      tracksRatings = {};
      loadRatings();
      updateTrackList = (0, import_function25.flow)(
        getTrackLists,
      ...
      mainElementObserver = new MutationObserver(() => CONFIG.showInTrackLists ? updateTrackList : void 0);
      ...
      Spicetify.Platform.History.listen(async ({ pathname }) => {
        const pageHasHeart = anyPass([URI9.isAlbum, URI9.isArtist, URI9.isPlaylistV1OrV2]);
        ...
        updateCollectionStars(
          pathname,
          (0, import_function25.pipe)(collectionStarsConstructs, Array_exports.unzip, ([_, starsStops]) => starsStops)
        );
      });
