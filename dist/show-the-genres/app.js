...
import { array as a3, string as str3, function as f4 } from "https://esm.sh/fp-ts";
...
import { array as a2, string as str2, function as f3 } from "https://esm.sh/fp-ts";
...
var SettingsSection = class _SettingsSection {
  constructor(name, sectionId, sectionFields = {}) {
    ...
    this.render = async () => {
      ...
      ReactDOM.render(/* @__PURE__ */ React2.createElement(this.FieldsContainer, null), pluginSettingsContainer);
    };
    ...
    this.FieldsContainer = () => /* @__PURE__ */ React2.createElement("div", { className: "x-settings-section" }, /* @__PURE__ */ React2.createElement("h2", { className: "Type__TypeElement-sc-goli3j-0 TypeElement-cello-textBase-type" }, this.name), Object.entries(this.sectionFields).map(([nameId, field]) => {
      return /* @__PURE__ */ React2.createElement(this.Field, { field });
    }));
    this.Field = ({ field }) => {
