...
// Types
export type VocalGroup<V extends BaseVocals | SyncedVocals> = {
...
// Class
export class LyricsScroller<V extends BaseVocals | SyncedVocals> implements Disposable {
    // Private Properties
    ...
    public constructor(
        ...
        lyricsContainer: HTMLDivElement,
        vocalGroups: VocalGroups<V>,
