...
import { Applicative, Applicative1, Applicative2, Applicative3, Applicative4, Applicative2C } from "fp-ts/Applicative";
 ...
 * @since 0.7.0
 */
export declare const none: <A>(f: Predicate<A>) => Predicate<Array<A>>;
/**
 ...
 * @since 0.6.0
 */
export declare const dropRepeats: <A>(eq: Eq<A>) => Endomorphism<Array<A>>;
/**
 ...
 * @since 0.12.0
 */
export declare function filterA<F extends URIS4>(F: Applicative4<F>): <S, R, E, A>(p: (x: A) => Kind4<F, S, R, E, boolean>) => (xs: Array<A>) => Kind4<F, S, R, E, Array<A>>;
export declare function filterA<F extends URIS3>(F: Applicative3<F>): <R, E, A>(p: (x: A) => Kind3<F, R, E, boolean>) => (xs: Array<A>) => Kind3<F, R, E, Array<A>>;
export declare function filterA<F extends URIS2>(F: Applicative2<F>): <E, A>(p: (x: A) => Kind2<F, E, boolean>) => (xs: Array<A>) => Kind2<F, E, Array<A>>;
export declare function filterA<F extends URIS2, E>(F: Applicative2C<F, E>): <A>(p: (x: A) => Kind2<F, E, boolean>) => (xs: Array<A>) => Kind2<F, E, Array<A>>;
export declare function filterA<F extends URIS>(F: Applicative1<F>): <A>(p: (x: A) => Kind<F, boolean>) => (xs: Array<A>) => Kind<F, Array<A>>;
export declare function filterA<F>(F: Applicative<F>): <A>(p: (x: A) => HKT<F, boolean>) => (xs: Array<A>) => HKT<F, Array<A>>;
/**
 ...
 * @since 0.14.0
 */
export declare const fromIterable: <A>(xs: Iterable<A>) => Array<A>;
/**
 ...
 * @since 0.14.0
 */
export declare const fromReadonly: <A>(xs: ReadonlyArray<A>) => Array<A>;
/**
 ...
 * @since 0.14.0
 */
export declare const toReadonly: <A>(xs: Array<A>) => ReadonlyArray<A>;
/**
 ...
 * @since 0.15.0
 */
export declare function allM<M extends URIS4>(M: Monad4<M>): <S, R, E>(xs: Array<Kind4<M, S, R, E, boolean>>) => Kind4<M, S, R, E, boolean>;
export declare function allM<M extends URIS3>(M: Monad3<M>): <R, E>(xs: Array<Kind3<M, R, E, boolean>>) => Kind3<M, R, E, boolean>;
export declare function allM<M extends URIS3, E>(M: Monad3C<M, E>): <R>(xs: Array<Kind3<M, R, E, boolean>>) => Kind3<M, R, E, boolean>;
export declare function allM<M extends URIS2>(M: Monad2<M>): <E>(xs: Array<Kind2<M, E, boolean>>) => Kind2<M, E, boolean>;
export declare function allM<M extends URIS2, E>(M: Monad2C<M, E>): (xs: Array<Kind2<M, E, boolean>>) => Kind2<M, E, boolean>;
 ...
 * @since 0.15.0
 */
export declare function anyM<M extends URIS4>(M: Monad4<M>): <S, R, E>(xs: Array<Kind4<M, S, R, E, boolean>>) => Kind4<M, S, R, E, boolean>;
export declare function anyM<M extends URIS3>(M: Monad3<M>): <R, E>(xs: Array<Kind3<M, R, E, boolean>>) => Kind3<M, R, E, boolean>;
export declare function anyM<M extends URIS3, E>(M: Monad3C<M, E>): <R>(xs: Array<Kind3<M, R, E, boolean>>) => Kind3<M, R, E, boolean>;
export declare function anyM<M extends URIS2>(M: Monad2<M>): <E>(xs: Array<Kind2<M, E, boolean>>) => Kind2<M, E, boolean>;
export declare function anyM<M extends URIS2, E>(M: Monad2C<M, E>): (xs: Array<Kind2<M, E, boolean>>) => Kind2<M, E, boolean>;
