 ...
 * @since 0.7.0
 */
export declare const ordMilliseconds: import("fp-ts/lib/Ord").Ord<Milliseconds>;
/**
 ...
 * @since 0.7.0
 */
export declare const fieldMilliseconds: import("fp-ts/lib/Field").Field<Milliseconds>;
/**
 ...
 * @since 0.7.0
 */
export declare const isoMilliseconds: import("monocle-ts").Iso<Milliseconds, number>;
/**
