 ...
 * @since 0.15.0
 */
export declare const sequenceArray_: <A>(xs: ReadonlyArray<Task<A>>) => Task<void>;
/**
 ...
 * @since 0.15.0
 */
export declare const sequenceSeqArray_: <A>(xs: ReadonlyArray<Task<A>>) => Task<void>;
/**
 ...
 * @since 0.15.0
 */
export declare const traverseArray_: <A, B>(f: (x: A) => Task<B>) => (xs: ReadonlyArray<A>) => Task<void>;
/**
 ...
 * @since 0.15.0
 */
export declare const traverseSeqArray_: <A, B>(f: (x: A) => Task<B>) => (xs: ReadonlyArray<A>) => Task<void>;
/**
